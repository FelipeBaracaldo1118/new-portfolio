const projects = [
  ...
  {
    id: 8,
    title: "Epam Systems(Epic Games) — Herramienta Interna de Monitoreo QA (Privado)  ",
    description:
      "Desarrollo de una herramienta interna para el monitoreo de métricas clave de operación dentro de un proyecto de QA para Epic Games. Proyecto privado alojado en servidores internos, sin demo público.",
    image: "/images/projects/pegasus.jpg",
    category: "Web App",
